...
console.log('\nSample extracted transactions with accurate amounts:');
for (const t of newState.transactions.slice(0, 15)) {
  console.log(`${t.date} | ${t.merchant} | $${t.amount.toFixed(2)} (${t.type})`);
}
